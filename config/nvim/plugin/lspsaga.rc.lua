...
vim.keymap.set('n', '<Leader>sh', '<Cmd>Lspsaga open_floaterm<CR>', saga_opts) -- ターミナルを開く
vim.keymap.set('t', '<C-d>', [[ <C-\><C-n><cmd>Lspsaga close_floaterm<CR>]], saga_opts) -- ターミナルを閉じる
